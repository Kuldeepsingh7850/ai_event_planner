    ...
    <>
      ...
      >
        <div className="flex flex-col gap-4 overflow-y-auto flex-1 pr-1 scrollbar-none">
          ...
          <div className="flex items-center gap-3 pb-4 border-b border-white/5 mb-2 mt-2">
            ...
            <div className="flex flex-col text-left">
              <span className="text-sm font-extrabold tracking-wider leading-tight text-white">
                JAGAH
              </span>
              <span className="text-[10px] text-indigo-400 font-bold uppercase tracking-widest leading-none mt-0.5">
                Udaipur
              </span>
            </div>
          </div>
        ...
        {/* Promo Upgrade Banner Box & Logout Link */}
        <div className="flex flex-col gap-4 pt-4 border-t border-white/5 bg-transparent">

          {/* Logout Shortcut */}
          <Link
            href="/logout"
            className="flex items-center gap-3 px-4 py-2 rounded-xl text-xs font-bold text-rose-500 hover:bg-rose-500/5 hover:text-rose-400 transition-all text-left w-full cursor-pointer"
          >
